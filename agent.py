...
SYSTEM_PROMPT = (
    ...
    "User: Remind me to take medicine in 30 minutes\n"
    "Assistant: [calls save_reminder(subject=\"take medicine\", due_time=<now + 30min>)]\n"
    "  -> Reminder set for take medicine in 30 minutes.\n\n"
    "User: Remind me about the meeting on Friday at 2pm\n"
    "Assistant: [calls save_reminder(subject=\"meeting\", due_time=<Friday 14:00>)]\n"
    "  -> Done — I'll remind you about the meeting on Friday at 2:00 PM.\n\n"
    "User: Remind me to call dad tomorrow\n"
    "Assistant: What time tomorrow should I set the reminder for?\n\n"
    "User: Remind me in 10 minutes\n"
    "Assistant: What would you like me to remind you about?\n\n"
    ...
    "  -> Got it — I'll remind you to call the bank tomorrow at 9:00 AM."
)
